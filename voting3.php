...
<div class="help">
<a class="btn btn-info" id="help"  href="help3.php"><i class="icon-info-sign icon-large"></i>&nbsp;Help</a>
</div>
</div>
...
<?php 
$governor=mysql_query("select * from candidate where Position='Governor'")or die(mysql_error());
...
<div class="gov-margin">
<?php 
$vice=mysql_query("select * from candidate where Position='Vice-Governor'")or die(mysql_error());
...
<font color="white">&nbsp;&nbsp;
&nbsp;
Candidate for 3rd Year Representative</font>
</div>
...
<?php 
$representative=mysql_query("select * from candidate where Position='3rd Year Representative'")or die(mysql_error());
