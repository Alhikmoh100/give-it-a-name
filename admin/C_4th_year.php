...
<div class="navbar">
    ...
    <li class="active"><a href="C_4th_year.php"><font color="white">4th Year Representative</font></a></li>
...
<?php $candidate_query=mysql_query("select  * from candidate where Position='4th Year Representative'");
