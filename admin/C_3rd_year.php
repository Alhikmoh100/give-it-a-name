...
<div class="navbar">
    ...
    <li class="active"><a href="C_3rd_year.php"><font color="white">3rd Year Representative</font></a></li>
...
<?php $candidate_query=mysql_query("select  * from candidate where Position='3rd Year Representative'");
