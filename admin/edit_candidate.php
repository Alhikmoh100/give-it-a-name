...
<div class="navbar">
	...
	<?php 
	$result=mysql_query("select * from candidate where CandidateID='$get_id'") or die(mysql_error());
	$row=mysql_fetch_array($result);
	?>
...
$image= addslashes(file_get_contents($_FILES['image']['tmp_name']));
	...
	$image_size= getimagesize($_FILES['image']['tmp_name']);
			...
			mysql_query("update candidate set FirstName='$rfirstname',LastName='$rlastname',Gender='$rgender',year='$ryear',Position='$rposition',MiddleName='$rname',Party='$party',Photo='$location' where CandidateID='$get_id'")or die(mysql_query);
			header('location:candidate_list.php');
			
			
			mysql_query("INSERT INTO history (data,action,date,user)VALUES('$rfirstname $rlastname', 'Edit Candidate', NOW(),'$user_name')")or die(mysql_error());
