...
<?php $voter_query=mysql_query("select  * from voters");
		while($voter_rows=mysql_fetch_array($voter_query)){ $id=$voter_rows['VoterID'];?>
...
<tr class="del<?php echo $id ?>">
	...
	<td align="center"><img class="pic" width="40" height="30" src="../<?php echo $voter_rows['Photo'];?>" border="0" onMouseOver="showtrail('../<?php echo $voter_rows['Photo'];?>','<?php echo $voter_rows['FirstName']." ".$voter_rows['LastName'];?> ',200,5)" onMouseOut="hidetrail()"></a></td>
	<td align="center"><?php echo $voter_rows['Status']; ?></td>
	<td align="center">
	<a class="btn btn-info" data-toggle="modal" href="#<?php echo $id; ?>" ><i class="icon-list icon-large"></i>&nbsp;Print Card</a>
...
<h1>Voter's Information</h1>
	  ...
	  <p><img src="../<?php echo $voter_rows['Photo'];?>" width="200" height="200"></p>
	  <div class="pull-right-modal">
	  <p>
	  FirstName:&nbsp;<?php echo $voter_rows['FirstName'];  ?>
	  </p>
	   <p>
	  LastName:&nbsp;<?php echo $voter_rows['LastName'];  ?>
	  </p>
	  <p>
	  MiddleName:&nbsp;<?php echo $voter_rows['MiddleName'];  ?>
	  </p>
	  
	  <p>
	  State:&nbsp;<?php echo $voter_rows['Year'];  ?>
	  </p>
	  </div>
	  </div>
	  <div class="modal-footer">
	  <a href="javascript:Clickheretoprint()" class="btn">Print</a>
	    <a href="#" class="btn" data-dismiss="modal">Close</a>
...
{ 
  ...
  var docprint=window.open("","",disp_setting); 
   ...
   docprint.document.write('<html><head><title>Voters Card</title>'); 
