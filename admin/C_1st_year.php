...
<div class="navbar">
    ...
    <li class="active"><a href="C_1st_year.php"><font color="white">1st Year Representative</font></a></li>
...
<?php $candidate_query=mysql_query("select  * from candidate where Position='1st Year Representative'");
