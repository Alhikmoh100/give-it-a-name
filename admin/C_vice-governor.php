...
<div class="navbar">
    ...
    <li><a href="C_governor.php"><font color="white">President</font></a></li>
    <li  class="active"><a href="C_vice-governor.php"><font color="white">Governor</font></a></li>
...
<?php $candidate_query=mysql_query("select  * from candidate where Position='Governor'");
