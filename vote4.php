...
<div class="back">
<a class="btn btn-info" id="bak"  href="voting4.php"><i class="icon-arrow-left icon-large"></i>&nbsp;Back</a>
</div>
</div>
...
//
//Representative1
$Representative1=mysql_query("select * from candidate where CandidateID='$representative1'")or die(mysql_query());
$Representative1_row=mysql_fetch_array($Representative1);

$name2=$Representative1_row['FirstName']."  ".$Representative1_row['LastName'];
//
//Representative2
$Representative2=mysql_query("select * from candidate where CandidateID='$representative2'")or die(mysql_query());
$Representative2_row=mysql_fetch_array($Representative2);

$name3=$Representative2_row['FirstName']."  ".$Representative2_row['LastName'];
//

//Representative3
$Representative3=mysql_query("select * from candidate where CandidateID='$representative3'")or die(mysql_query());
$Representative3_row=mysql_fetch_array($Representative3);
...
$rep1=$_POST['rep1'];
mysql_query("insert into votes (CandidateID)values('$rep1')")or die(mysql_error());


$rep2=$_POST['rep2'];
mysql_query("insert into votes (CandidateID)values('$rep2')")or die(mysql_error());

$rep3=$_POST['rep3'];
mysql_query("insert into votes (CandidateID)values('$rep3')")or die(mysql_error());
